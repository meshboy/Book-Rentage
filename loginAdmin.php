<?php
        ...
        if (isset($_POST['login']))
        {
            ...
            {
                adminlogin($_POST['user'], $_POST['pass']);
            }

            else
            {
                $_SESSION['error'] = "Please fill in the required field";
            }
            ...
            <div class="panel-body panel-default">
                <form class="form-group"  action="" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" size="80" placeholder="Username" name="user">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" size="80" placeholder="Password" name="pass">
                    </div>



                        <input type="submit" value="Submit" class="btn" name="login" id="button">
