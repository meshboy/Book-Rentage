        ...
        <div class="well-sm1" >
            <div class="collapse navbar-collapse" id="back">
                <ul class="nav navbar-nav " id="navBar">
                    ...
                    <li><a href="return.php" class="active bg-warning">Return</a></li>
                </ul>
        ...
        <div class="container">
            <div class="col-lg-4" id="left">
                ...
                <ul class="nav navbar-collapse" id="mynav">
                    ...
                    <li><a href="recent.php" >Recent Orders</a></li>
                    <li><a href="#return" class="active bg-success"  data-toggle="tab">Return Items</a></li>
            ...
            <div class="col-lg-6">
                ...
                <div class="tab-pane fade in active" id="return">
                    <label id="login">Returning your books is easy and free</label><br/>
