...
<div class="container">
    <div class="col-lg-4" id="left">
        ...
        <ul class="nav navbar-collapse" id="mynav">
            ...
            <li><a href="#reward" class="active bg-success" data-toggle="tab">Rewards & Credits</a></li>
    ...
    <div class="col-lg-6">
        <div class="tab-pane fade in active" id="reward">
            <label id="login">Reward</label><br/>
